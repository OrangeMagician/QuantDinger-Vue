...
const components = {
  ...
  "settings.group.market_catalog": "Instrument Catalog",
  "settings.marketCatalog.overviewTitle": "Crypto instrument catalog",
  "settings.marketCatalog.description": "This sync refreshes spot/contract codes, names, and availability from exchanges. It does not download K-line bars. Startup and scheduled jobs refresh it automatically.",
  "settings.marketCatalog.syncNow": "Sync now",
  "settings.marketCatalog.syncing": "Syncing",
  "settings.marketCatalog.started": "Instrument catalog sync started",
  "settings.marketCatalog.alreadyRunning": "An instrument catalog sync is already running",
  "settings.marketCatalog.startFailed": "Unable to start instrument catalog sync",
  ...
  "settings.marketCatalog.runningDescription": "The service is refreshing spot and contract catalogs from enabled exchanges in parallel.",
  ...
  "settings.marketCatalog.status.disabled": "Disabled",
...
const locale = {
  ...
  "aiCopilot.setup.llm.meta": "AI service error",
  "aiCopilot.setup.llm.title": "The AI service returned an invalid response",
  "aiCopilot.setup.llm.body": "The AI configuration was loaded, but the endpoint did not return a usable model response. Check the model, the OpenAI-compatible Base URL, server connectivity, and response format.",
  "aiCopilot.setup.unknown.meta": "Request error",
  "aiCopilot.setup.unknown.title": "The request could not be completed",
  "aiCopilot.setup.unknown.body": "The request did not return a usable result. Review the error below and check the related configuration before retrying.",
  ...
  "trading-assistant.template.strategy_v2_bullish_three_lines_trend": "Bullish Three Averages With Trend Filter",
  ...
  "trading-assistant.template.strategy_v2_macd_kdj": "MACD and KDJ Confirmation",
  "trading-assistant.template.strategy_v2_supertrend": "SuperTrend Trend Following",
  "trading-assistant.template.strategy_v2_market_cap_barbell": "Small and Large Cap Barbell",
  ...
  "indicatorIde.czsc.multiPeriod": "Multi-period analysis",
  "indicatorIde.czsc.multiPeriodContext": "Current chart period: {timeframe}",
  "indicatorIde.czsc.periods": "Analysis periods",
  "indicatorIde.czsc.refreshMultiPeriod": "Refresh analysis",
  "indicatorIde.czsc.applyToChart": "Apply to chart",
  "indicatorIde.czsc.appliedToChart": "Chart switched to {timeframe}",
  "indicatorIde.czsc.multiPeriodEmpty": "Select at least two periods to start analysis",
  "indicatorIde.czsc.multiPeriodSelectAtLeast": "Select at least two analysis periods",
  "indicatorIde.czsc.computing": "Computing CZSC structure",
  "indicatorIde.czsc.failed": "CZSC structure calculation failed",
  "indicatorIde.czsc.notEnoughBars": "At least 20 bars are required for CZSC structure",
  "indicatorIde.builtin.superTrendName": "[Sample] SuperTrend Trend-Following",
  "indicatorIde.builtin.superTrendDescription": "SuperTrend uses adaptive ATR bands to identify trend flips. Red marks an uptrend, green marks a downtrend, and buy/sell markers are chart analysis only.",
  "indicatorIde.builtin.superTrendUp": "SuperTrend Uptrend",
  "indicatorIde.builtin.superTrendDown": "SuperTrend Downtrend",
  "indicatorIde.builtin.buyPointShort": "Buy",
  "indicatorIde.builtin.sellPointShort": "Sell",
  ...
  "indicatorIde.screenerReview.return": "Back to screener",
  "indicatorIde.screenerReview.source": "Screener review",
  "indicatorIde.screenerReview.decisionScore": "Decision",
  "indicatorIde.screenerReview.matchScore": "Match",
  "indicatorIde.screenerReview.previous": "Previous candidate",
  "indicatorIde.screenerReview.next": "Next candidate",
  "indicatorIde.screenerReview.position": "{current} / {total}",
...
export default {
  ...
  "trendChart.adjustHfq": "Backward adjusted",
  "trendChart.single": "Single period",
  "trendChart.multi": "Multi-period",
  "trendChart.refresh": "Refresh chart and layers",
  "trendChart.engineSource": "Compute engine: ",
  "trendChart.loadingBars": "Loading market bars",
  "trendChart.barsFailed": "Market bars failed to load",
  "trendChart.noBars": "No market bars are available",
  "trendChart.layers": "Layers",
  "trendChart.fractals": "Fractals",
  "trendChart.strokes": "Strokes",
  "trendChart.unfinished": "Developing structures",
  "trendChart.signals": "Buy/sell points and signals",
  "trendChart.layerUnavailable": "The CZSC structure layer is unavailable; market bars remain usable",
  "trendChart.computing": "Computing",
  "trendChart.degraded": "Degraded",
  "trendChart.ready": "Ready",
  "trendChart.waiting": "Waiting",
  "trendChart.dataset": "Dataset version",
  "trendChart.noSignals": "No current signals",
  "trendChart.multiSummary": "Multi-period resonance and direction comparison",
  "trendChart.multiFailed": "Multi-period analysis failed",
  "trendChart.direction": "Direction",
  "trendChart.resonance": "Resonance",
  "trendChart.bullishPeriods": "Bullish periods",
  "trendChart.bearishPeriods": "Bearish periods",
  "trendChart.score": "Score",
  "trendChart.bullish": "Bullish",
  "trendChart.bearish": "Bearish",
  "trendChart.neutral": "Neutral",
  "trendChart.taskFailed": "Calculation task failed",
  "trendChart.taskTimeout": "Calculation task timed out",
  "trendChart.legacyImported": "Imported {count} legacy CZSC research results",
  "czsc.top": "Top fractal",
  "czsc.bottom": "Bottom fractal",
  "czsc.unfinishedShort": "Open",
  "taskCenter.title": "Task Center",
  "taskCenter.subtitle": "Research, screening, backtest, and chart-layer tasks",
  "taskCenter.allStatuses": "All statuses",
  "taskCenter.refresh": "Refresh",
  "taskCenter.total": "Listed",
  "taskCenter.active": "Active",
  "taskCenter.succeeded": "Succeeded",
  "taskCenter.failed": "Failed",
  "taskCenter.task": "Task",
  "taskCenter.engine": "Engine",
  "taskCenter.status": "Status",
  "taskCenter.createdAt": "Created",
  "taskCenter.cancel": "Cancel task",
  "taskCenter.retry": "Retry task",
  "taskCenter.detail": "Task detail",
  "taskCenter.taskId": "Task ID",
  "taskCenter.taskType": "Task type",
  "taskCenter.strategyVersion": "Strategy version ID",
  "taskCenter.attempts": "Execution attempts",
  "taskCenter.provenance": "Result provenance",
  "taskCenter.dataset": "Dataset version",
  "taskCenter.engineVersion": "Engine version",
  "taskCenter.adapterVersion": "Adapter version",
  "taskCenter.inputDigest": "Input digest",
  "taskCenter.loadFailed": "Failed to load tasks",
  "taskCenter.cancelRequested": "Cancellation requested",
  "taskCenter.retryRequested": "Retry submitted",
  "taskCenter.statuses.queued": "Queued",
  "taskCenter.statuses.dispatching": "Dispatching",
  "taskCenter.statuses.running": "Running",
  "taskCenter.statuses.cancel_requested": "Cancelling",
  "taskCenter.statuses.succeeded": "Succeeded",
  "taskCenter.statuses.failed": "Failed",
  "taskCenter.statuses.cancelled": "Cancelled",
  "taskCenter.statuses.timed_out": "Timed out",
  "taskCenter.types.analyze": "Structure layer",
  "taskCenter.types.multi_period": "Multi-period analysis",
  "taskCenter.types.backtest": "Strategy backtest",
  "taskCenter.types.factor_lab": "Factor research",
  "taskCenter.types.signal_quality": "Signal quality",
  "taskCenter.types.signal_factor_screener": "Screening",
  "taskCenter.types.watchlist_scan": "Watchlist scan",
  ...
  "marketScreener.universe": "Universe",
  "marketScreener.watchlist": "Watchlist",
  "marketScreener.stockPool": "Stock pool",
  "marketScreener.manual": "Manual",
  "marketScreener.emptyWatchlist": "The watchlist has no A-share symbols",
  "marketScreener.symbolPlaceholder": "Enter symbols separated by commas, spaces, or new lines",
  "marketScreener.excludeSt": "Exclude ST stocks",
  "marketScreener.poolLimit": "Pool size",
  "marketScreener.industries": "Industries / themes",
  ...
  "marketScreener.value": "Value",
  "marketScreener.conditionType": "Condition",
  "marketScreener.operator": "Relation",
  "marketScreener.expectedState": "Expected state",
  "marketScreener.valueRange": "Value range",
  "marketScreener.rangeTo": "to",
  "marketScreener.logic": "Match rule",
  "marketScreener.logicAnd": "Match all",
  "marketScreener.logicOr": "Match any",
  "marketScreener.timeframe": "Timeframe",
  "marketScreener.timeframe5m": "5 minutes",
  "marketScreener.timeframe30m": "30 minutes",
  "marketScreener.timeframe1d": "Daily",
  "marketScreener.barLimit": "Bars",
  "marketScreener.operator.eq": "Equals",
  "marketScreener.operator.ne": "Does not equal",
  "marketScreener.operator.gt": "Greater than",
  "marketScreener.operator.gte": "Greater than or equal",
  "marketScreener.operator.lt": "Less than",
  "marketScreener.operator.lte": "Less than or equal",
  "marketScreener.operator.between": "Between",
  "marketScreener.operator.truthy": "Is true",
  "marketScreener.operator.falsy": "Is false",
  "marketScreener.operator.exists": "Appeared",
  "marketScreener.operator.not_exists": "Did not appear",
  "marketScreener.operator.matched": "Matched",
  "marketScreener.run": "Run screen",
  "marketScreener.results": "Results",
  "marketScreener.noResults": "No matching results",
  "marketScreener.running": "The screening task is running",
  "marketScreener.symbol": "Symbol",
  "marketScreener.score": "Score",
  "marketScreener.signals": "Signals",
  "marketScreener.explanation": "Explanation",
  "marketScreener.addWatchlist": "Add to watchlist",
  "marketScreener.addedWatchlist": "Added to the shared watchlist",
  "marketScreener.summary": "Scanned {requested} symbols, matched {matched}",
  "marketScreener.loadFailed": "Failed to load the screener catalog",
  "marketScreener.runFailed": "Stock screening failed",
  "marketScreener.planSelect": "Load screen plan",
  "marketScreener.savePlan": "Save screen plan",
  "marketScreener.planName": "Plan name",
  "marketScreener.planSaved": "Screen plan saved",
  "marketScreener.history": "Run history",
  "marketScreener.exchanges": "Listings",
  "marketScreener.exchangeSh": "Shanghai",
  "marketScreener.exchangeSz": "Shenzhen",
  "marketScreener.exchangeBj": "Beijing",
  "marketScreener.excludeRecent": "Minimum listing days",
  "marketScreener.priceRange": "Price range (CNY)",
  "marketScreener.marketCapRange": "Market cap range (CNY 100m)",
  "marketScreener.peRange": "P/E range",
  "marketScreener.previewPool": "Preview universe",
  "marketScreener.poolPreviewSummary": "Will scan {selected}/{total}; excluded ST {st}, classification {industry}, fundamentals {fundamental}; metadata covers {metadata}",
  "marketScreener.snapshotStatus": "Latest factor snapshot covers {count} symbols, refreshed {time}",
  "marketScreener.templates": "Templates",
  "marketScreener.templateTrend": "Trend launch",
  "marketScreener.templateBreakout": "Volume breakout",
  "marketScreener.templateReversal": "Bottom reversal",
  "marketScreener.templatePullback": "Trend pullback",
  "marketScreener.modeMust": "Must",
  "marketScreener.modeShould": "Boost",
  "marketScreener.modeExclude": "Exclude",
  "marketScreener.lookback": "Last N bars",
  "marketScreener.groupFeature": "Technical states",
  "marketScreener.groupSignal": "Enhanced signals",
  "marketScreener.groupFactor": "Factor library",
  "marketScreener.groupTemplate": "Strategy templates",
  "marketScreener.batchWatchlist": "Add selected",
  "marketScreener.validate": "Historical validation",
  "marketScreener.sendReview": "Send to review",
  "marketScreener.cancel": "Cancel",
  "marketScreener.confirm": "Confirm",
  "marketScreener.cancelRequested": "Cancellation requested",
  "marketScreener.progressDetail": "Processed {processed}/{total}, matched {matched}, failed {failed}, cached {cached}",
  "marketScreener.scanned": "Scanned",
  "marketScreener.matched": "Matched",
  "marketScreener.near": "Near matches",
  "marketScreener.failed": "Failed",
  "marketScreener.cacheHits": "Snapshot hits",
  "marketScreener.generatedAt": "Generated",
  "marketScreener.tabMatched": "Matched ({count})",
  "marketScreener.tabNear": "Near ({count})",
  "marketScreener.tabFailed": "Failed ({count})",
  "marketScreener.tabAll": "All diagnostics",
  "marketScreener.matchScore": "Match",
  "marketScreener.technicalScore": "Technical",
  "marketScreener.conditionDiagnosis": "Condition diagnostics",
  "marketScreener.dataTime": "Data time",
  "marketScreener.openChart": "Open chart",
  "marketScreener.batchAdded": "Added {count} symbols to the watchlist",
  "marketScreener.validationResult": "Historical validation",
  "marketScreener.noValidationSamples": "No historical match samples are available",
  "marketScreener.horizon": "Horizon",
  "marketScreener.horizonBars": "Next {count} bars",
  "marketScreener.samples": "Samples",
  "marketScreener.averageReturn": "Average return",
  "marketScreener.medianReturn": "Median return",
  "marketScreener.winRate": "Win rate",
  "marketScreener.worstReturn": "Worst return",
  "marketScreener.reviewConfirmTitle": "Send to Retraq manual review",
  "marketScreener.reviewConfirmBody": "Send {count} candidates as PENDING signals for manual review. No order will be placed automatically.",
  "marketScreener.reviewSubmitted": "Submitted {count} pending signals",
  "marketScreener.historyTitle": "Scanned {requested}, matched {matched}",
  "marketScreener.openRun": "Open this run",
  "marketScreener.name": "Name",
  "marketScreener.selectedCount": "{count} selected",
  "marketScreener.clearSelection": "Clear selection",
  "marketScreener.refreshResults": "Refresh results",
  "marketScreener.exportResults": "Export current results",
  "marketScreener.retry": "Retry task",
  "marketScreener.taskFailed": "Screening task did not complete",
  "marketScreener.loadResultsFailed": "Failed to load results",
  "marketScreener.qualityAll": "All data quality",
  "marketScreener.qualityEligible": "Eligible data only",
  "marketScreener.qualityBlocked": "Quality-blocked only",
  "marketScreener.sortDecision": "Sort by decision score",
  "marketScreener.sortMatch": "Sort by match score",
  "marketScreener.sortTechnical": "Sort by technical score",
  "marketScreener.sortLatest": "Sort by latest data",
  "marketScreener.sortSymbol": "Sort by symbol",
  "marketScreener.sortDesc": "Descending",
  "marketScreener.sortAsc": "Ascending",
  "marketScreener.qualitySummary": "{eligible} rows eligible, {blocked} blocked by data quality",
  "marketScreener.batchAddedWithFailures": "Added {count}; {failed} failed",
  "marketScreener.conditionsCount": "conditions",
  "marketScreener.symbolCount": "symbols",
  "marketScreener.draftRestored": "Restored the last unsaved screening configuration",
  "marketScreener.noExplanation": "No diagnostic explanation",
  "marketScreener.yes": "Pass",
  "marketScreener.no": "Fail",
  "marketScreener.resetConfiguration": "Reset screen configuration",
  "marketScreener.resetConfigurationConfirm": "Restore the default universe, conditions, timeframe, and portfolio settings? This replaces the current draft.",
  "marketScreener.draftReady": "Configuration autosave",
  "marketScreener.draftSaving": "Saving draft",
  "marketScreener.draftSaved": "Draft saved {time}",
  "marketScreener.validSymbols": "{count} valid symbols",
  "marketScreener.invalidSymbols": "Remove {count} invalid symbols",
  "marketScreener.duplicateCondition": "Duplicate condition",
  "marketScreener.issueEmptyWatchlist": "The watchlist has no A-share symbols to screen",
  "marketScreener.issueNoValidSymbols": "Enter at least one valid A-share symbol",
  "marketScreener.issueInvalidSymbols": "Remove the {count} invalid symbols before running",
  "marketScreener.issueNoConditions": "Add at least one complete screening condition",
  "marketScreener.issueIncompleteCondition": "Condition {index} is incomplete",
  "marketScreener.readySummary": "Ready: about {symbols} symbols, {conditions} conditions, {timeframe}",
  "marketScreener.fixIssue": "Locate issue",
  "marketScreener.searchResults": "Search symbol or company name",
  "marketScreener.minDecision": "Min decision",
  "marketScreener.minMatch": "Min match",
  "marketScreener.resetFilters": "Reset filters",
  "marketScreener.filteredCount": "{count} filtered rows",
  "marketScreener.selectionPersists": "{count} symbols selected across pages",
  "marketScreener.selectCurrentPage": "Select this page",
  "marketScreener.selectTopCandidates": "Select top 20 on page",
  "marketScreener.exportCurrentPage": "Export current page",
  "marketScreener.exportSelected": "Export {count} selected",
  "marketScreener.compareCandidates": "Compare candidates",
  "marketScreener.compareLimit": "For readability, only the first four selected symbols are compared.",
  "marketScreener.reviewCharts": "Review charts",
  "marketScreener.previousCandidate": "Previous",
  "marketScreener.nextCandidate": "Next",
  "marketScreener.candidatePosition": "{current} of {total}",
  "unifiedFactor.assetName": "A-share Factor Research",
  "unifiedFactor.researchType": "Research task",
  "unifiedFactor.experiment": "Factor experiment",
  "unifiedFactor.quality": "Quality scoring",
  "unifiedFactor.forwardBars": "Forward bars",
  "unifiedFactor.sampleStep": "Sample step",
  "unifiedFactor.experimentTitle": "Factor Experiment Result",
  "unifiedFactor.qualityTitle": "Signal Quality Score",
  "unifiedFactor.factorSeries": "Factor Series",
  "unifiedFactor.seriesHint": "Factor values for the selected symbol and timeframe",
  "unifiedFactor.decayChart": "Signal Return Decay",
  "unifiedFactor.decayHint": "Direction-adjusted returns across forward horizons",
  "unifiedFactor.factorDetails": "Factor Details",
  "unifiedFactor.qualityMetrics": "Quality Metrics",
  "unifiedFactor.recentEvents": "Recent Samples",
  "unifiedFactor.relatedSignals": "Related Signals",
  "unifiedFactor.provenance": "Provenance",
  "unifiedFactor.engine": "Engine",
  "unifiedFactor.dataset": "Dataset Snapshot",
  "unifiedFactor.resultId": "Result ID",
  "unifiedFactor.taskId": "Task ID",
  "unifiedFactor.generatedAt": "Generated At",
  "unifiedFactor.readOnly": "Research Only",
  "unifiedFactor.signalTypes": "Signal Types",
  "unifiedFactor.samples": "Samples",
  "unifiedFactor.bestSignal": "Best Signal",
  "unifiedFactor.bestScore": "Best Quality Score",
  "unifiedFactor.winRate": "Win Rate",
  "unifiedFactor.forwardReturn": "Forward Return",
  "unifiedFactor.factorCount": "Factors",
  "unifiedFactor.latestValue": "Latest Value",
  "unifiedFactor.points": "Series Points",
  "unifiedFactor.category": "Category",
  "unifiedFactor.latestBar": "Latest Bar",
  "unifiedFactor.signalType": "Signal Type",
  "unifiedFactor.qualityScore": "Quality Score",
  "unifiedFactor.profitLossRatio": "Profit/Loss Ratio",
  "unifiedFactor.falseBreakout": "False Breakout Rate",
  "unifiedFactor.factor": "Factor",
  "unifiedFactor.explanation": "Explanation",
  "unifiedFactor.riskTip": "Risk Tip",
  "unifiedFactor.time": "Time",
  "unifiedFactor.direction": "Direction",
  "unifiedFactor.confidence": "Confidence",
  "unifiedFactor.score": "Score",
  "unifiedBacktest.czscMode": "Strategy backtest",
  "unifiedBacktest.engineHint": "Select a QuantDinger strategy asset; its version automatically selects the CZSC engine.",
  "unifiedBacktest.strategy": "Strategy asset and version",
  "unifiedBacktest.symbol": "Backtest symbol",
  "unifiedBacktest.timeframe": "Timeframe",
  "unifiedBacktest.limit": "Maximum bars",
  "unifiedBacktest.empty": "Select a strategy and symbol to run a backtest",
  "unifiedBacktest.running": "The isolated backtest task is running",
  "unifiedBacktest.strategyLoadFailed": "Failed to load strategy assets",
  "strategyCenter.assets.tab": "Strategy Assets",
  "strategyCenter.assets.instances": "Runtime Instances",
  "strategyCenter.assets.total": "strategy assets",
  "strategyCenter.assets.hint": "Business kind and engine are independent; one version flows through research, backtest, review, and runtime.",
  "strategyCenter.assets.create": "Create Strategy Asset",
  "strategyCenter.assets.name": "Strategy",
  "strategyCenter.assets.kind": "Business Kind",
  "strategyCenter.assets.engine": "Engine Source",
  "strategyCenter.assets.version": "Version",
  "strategyCenter.assets.status": "Status",
  "strategyCenter.assets.updated": "Updated",
  "strategyCenter.assets.published": "Published",
  "strategyCenter.assets.draft": "Draft",
  "strategyCenter.assets.backtest": "Open Unified Backtest",
  "strategyCenter.assets.review": "Open Signal Reviews",
  "strategyCenter.assets.edit": "Edit Strategy Definition",
  "menu.dashboard.signalReviews": "Signal Reviews",
  "signalReviews.title": "Signal Reviews",
  "signalReviews.subtitle": "Review candidates against real strategy versions",
  "signalReviews.reviewBoundary": "Review changes the QuantDinger signal state only. The CZSC Worker has no broker credentials and cannot submit orders.",
  "signalReviews.generateHint": "Evaluate the latest bar with this strategy version; matches enter manual review.",
  "signalReviews.generate": "Generate Candidate",
  "signalReviews.generated": "The candidate entered the manual review queue",
  "signalReviews.noCandidate": "The latest bar did not match a strategy event",
  "signalReviews.generateFailed": "Candidate evaluation failed",
  "signalReviews.strategy": "Strategy and version",
  "signalReviews.signal": "Candidate signal",
  "signalReviews.status": "Status",
  "signalReviews.time": "Signal time",
  "signalReviews.approve": "Approve",
  "signalReviews.reject": "Reject",
  ...
  "indicatorIde.syncTodayKlineCanonical": "Canonical K-line data is complete; temporary server bars were removed automatically",
  ...
  "indicatorIde.klineQuality.invalid": "The returned data contains invalid values",
  "indicatorIde.klineQuality.empty": "No K-line bars are available",
